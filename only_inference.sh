accelerate launch --config_file /data7/sooyeon/LyCORIS/gpu_4_5_config --main_process_port 24164 only_inference.py \
                  ...
                  --save_folder_name 'inference_inference_te_inlayer_projg_in_ff_net' \
                  --network_module networks.lora --efficient_layer 'text,proj_in,ff_net,down_blocks_2,mid,up_blocks_1' \
