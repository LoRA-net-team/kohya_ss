CUDA_VISIBLE_DEVICES=0 python gen_crossattnmap.py \
      ...
      --network_weights './result/haibara_experience/one_image/name_3/haibara_3_1_image_base/haibara-000026.safetensors' \
      --from_file '/data7/sooyeon/LyCORIS/LyCORIS/test/test_haibara_inference.txt' \
      --outdir ./result/haibara_experience/one_image/name_3/haibara_3_1_image_base/inference_attention/haibara_epoch_26 --seed 42 --trg_token 'haibara' \
