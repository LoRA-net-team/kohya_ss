python image_inverting.py --device cuda:5  --process_title parksooyeon \
                          ...
                          --output_dir ./result/perfusion_experiment/cat/20231029_random_init_guidance_8_min_5_max_30_only_value_control --seed 42 --guidance_scale 8 \
                          --num_ddim_steps 50 --min_value 5 --max_self_input_time 30
