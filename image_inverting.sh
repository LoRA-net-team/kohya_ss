python image_inverting.py --device cuda:5  --process_title parksooyeon \
                          ...
                          --output_dir ./result/inference_result/perfusion_experiment/cat/random_init_guidance_8_ddim_50_only_values_without_background_img --seed 42 --guidance_scale 8 \
