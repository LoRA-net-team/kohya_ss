...
block_res_dict = {64 : ["unet_down_blocks_0","unet_up_blocks_3",],
                  32 : ["unet_down_blocks_1","unet_up_blocks_2",],
                  16 : ["unet_down_blocks_2","unet_up_blocks_1",],
                  8 : ["unet_mid_block"]}
"""
BLOCKS = ["text_model",
...
class LoRANetwork(torch.nn.Module):
    ...
    def set_block_lr_weight(self,up_lr_weight: List[float] = None,
                            mid_lr_weight: float = None,down_lr_weight: List[float] = None,):
        self.block_lr = True
