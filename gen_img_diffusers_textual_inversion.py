...
if __name__ == "__main__":
    ...
    parser.add_argument("--use_original_file_name", action="store_true",
                        help="prepend original file name in img2img / img2img",)
    ...
    parser.add_argument("--vae_batch_size", type=float, default=None,
                        help="batch size for VAE, < 1.0 for ratio / VAE",)
    ...
    parser.add_argument("--seed", type=int, default=None, help="seed, or seed of seeds in multiple generation",)
    ...
    parser.add_argument("--network_pre_calc", action="store_true", help="pre-calculate network for generation")
    parser.add_argument("--textual_inversion_embeddings", type=str, default=None,
                        nargs="*", help="Embeddings files of Textual Inversion / Textual Inversionのembeddings",)
    parser.add_argument("--XTI_embeddings", type=str, default=None,
                        nargs="*", help="Embeddings files of Extended Textual Inversion / Extended Textual Inversionのembeddings",)
    ...
    parser.add_argument("--clip_guidance_scale", type=float, default=0.0,
                        help="enable CLIP guided SD, scale for guidance (DDIM, PNDM, LMS samplers only) / CLIP guided SD",)
    ...
    parser.add_argument("--vgg16_guidance_layer", type=int, default=20,
                        help="layer of VGG16 to calculate contents guide (1~30, 20 for conv4_2) / VGG16のcontents guide",)
    ...
    parser.add_argument("--highres_fix_steps", type=int, default=28, help="1st stage steps for highres fix / highres fixの最初のステージのステップ数")
    parser.add_argument("--highres_fix_strength",type=float,default=None,
                        help="1st stage img2img strength for highres fix / highres fixの最初のステージのimg2img",)
    ...
    parser.add_argument("--highres_fix_upscaler", type=str, default=None,
    ...
    parser.add_argument("--control_net_ratios",
                        type=float,
                        default=None,
                        nargs="*",
