...
class NetworkTrainer:
    ...
    def train(self, args):
        ...
        print(f'\n step 9. SD model (original and lora form) ')
        ...
        print(f'\n step 12. text encoder ( to accelerate device) ')
        ...
        print(f'\n step 15. text encoder pretraining dataset and dataloader')
        ...
        if len(text_encoders) > 1:
            ...
            unet, text_encoder, text_encoder_org, network, optimizer, pretraining_dataloader, lr_scheduler = accelerator.prepare(unet, text_encoder,text_encoder_org,
