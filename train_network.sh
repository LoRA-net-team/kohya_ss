accelerate launch --config_file /data7/sooyeon/LyCORIS/gpu_config/gpu_0_1_config --main_process_port 20164 train_network_pretraining.py \
                  ...
                  --wandb_run_name iom_pretrain_sen_10_inlayers_heatmap_backprop_infer_inlayers_class_preserving \
                  --output_dir ../result/perfusion_experiment/cat/iom_pretrain_sen_10_inlayers_heatmap_backprop_infer_inlayers_class_preserving \
