accelerate launch --config_file /data7/sooyeon/LyCORIS/gpu_config/gpu_2_3_config --main_process_port 22364 train_network_pretraining.py \
                  ...
                  --wandb_run_name iom_pretrain_sen_10_unet_inlayers_heatmap_backprop_infer_inlayers_class_preserving \
                  --output_dir ../result/perfusion_experiment/cat/iom_pretrain_sen_10_unet_inlayers_heatmap_backprop_infer_inlayers_class_preserving \
