accelerate launch --config_file /data7/sooyeon/LyCORIS/gpu_6_7_config --main_process_port 26764 train_network_pretraining.py \
                  ...
                  --wandb_run_name te_pretrain_581_sen_25_preserving_class_token_pretraining_except_crossattn_kv \
                  --output_dir ./result/perfusion_experiment/teddy_bear/te_pretrain_581_sen_25_preserving_class_token_pretraining_except_crossattn_kv \
                  ...
                  --pretraining_epochs 10 --unet_net_key_names 'proj_in,ff_net,attn1,attn2_to_q,attn2_to_out' \
