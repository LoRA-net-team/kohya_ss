...
def generate_step_logs(args: argparse.Namespace, current_loss, avr_loss, lr_scheduler, keys_scaled=None, mean_norm=None,
                              maximum_norm=None):
        ...
        for i in range(idx, len(lrs)):
            ...
            if args.optimizer_type.lower().startswith(
                ...
                logs[f"lr/d*lr/group{i}"] = (
                    ...
                    "lr"]  )
    return logs
def get_text_cond(args, accelerator, batch, tokenizers, text_encoders, weight_dtype):
...
def train(args):
    ...
    try:
        ...
        accelerator.print(
            ...
            "instead of prepare_optimizer_params(text_encoder_lr, unet_lr)")
    ...
    save_base = args.output_dir
    os.makedirs(save_base, exist_ok=True)
    config_save_dir = os.path.join(save_base, 'config.json')
    ...
    for epoch in range(num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(network):
                ...
                with torch.set_grad_enabled(train_text_encoder):
                    ...
                    if args.weighted_captions:
                        ...
                        text_encoder_conds = get_text_cond(
                ...
                with accelerator.autocast():
                    noise_pred = unet(noisy_latents, timesteps, text_encoder_conds).sample
            ...
            if args.logging_dir is not None:
                ...
                try:
                    loss_dict[global_step].append(current_loss)

                except:
                    loss_dict[global_step] = []
                    loss_dict[global_step].append(current_loss)
    ...
    gradient_dict_save_dir = os.path.join(save_base, 'gradient_norm.pickle')
